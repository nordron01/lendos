...
fields: [
 ...
 var connect2 = false;
	...
	document.getElementById('reg').addEventListener("click", function(){
				    ...
				    var regpswd = document.getElementById('regpswd').value;
				    var regpswd1 = document.getElementById('regpswd1').value;

				    var regname =   document.getElementById('regname').value;
				    var regsur =    document.getElementById('regsur').value;
				    var reglast =   document.getElementById('reglast').value;
				    var studstep =  document.getElementById('studstep').value;
				    var position =  document.getElementById('position').value;
				    var email =     document.getElementById('email').value;
				    var telfon =    document.getElementById('telfon').value;
				  ...
				  //console.log('prov'+prov2);
				  var prov3=par_pattern.test(regpswd);
				  // console.log(prov3);
				  if (prov===true &&  prov3===true && prov2===true) {
  ...
  document.getElementById("Login").addEventListener("click",function(){
	    var reglogin = document.getElementById('usernameInput').value;
	    var regpswd = document.getElementById('passnameInput').value;
  ...
  socket.on('up rooms',function(data){
    ...
    socket.on('conec', function(data){

     document.getElementById('redisoputput').value = data;
  ...
  // Socket events
   ...
   function addchatlist(data){
		  ...
		  console.log(text);
		     $("#chatlog1").append( text);
		     
		  //$("#chatlog").animate({ scrollTop: $(document).height() }, "slow");
      } 
  ...
  // Whenever the server emits 'new message', update the chat body
	socket.on('message', function (data) {
	   ...
	   addchatlist(data);
	  var  textarea = $("#chatlog1")
	  var dowm = document.getElementById("chatlog1").scrollHeight;
	  console.log(dowm);
	    textarea.scrollTop(dowm);
	  });
