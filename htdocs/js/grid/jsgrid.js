...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        pagePrevText: "Пред.",
        pageNextText: "След.",
        pageFirstText: "Первый",
        pageLastText: "Последний",
        ...
        loadMessage: "Подождите загрузка...",
        loadShading: true,
...
(function(jsGrid, $, undefined) {
    ...
    TextField.prototype = new Field({
        ...
        _createTextBox: function() {
            return $('<input class="shorting">').attr("type", "text")
...
(function(jsGrid, $, undefined) {
    ...
    NumberField.prototype = new TextField({
        ...
        _createTextBox: function() {
			return $('<input class="shorting">').attr("type", "number")
                .prop("readonly", !!this.readOnly);
        }
    });
...
(function(jsGrid, $, undefined) {
    ...
    SelectField.prototype = new NumberField({
        ...
        _createSelect: function() {
                var predefault = $('<input type="text" class="shorting" id="src'+glob_id_item+'" >');
            var $result = $('<select class="shorting" id="src'+glob_id_item+'">'),
                valueField = this.valueField,
                textField = this.textField,
                selectedIndex = this.selectedIndex;
               // <input type="text" class="shorting" id="src'+glob_id_item+'" >    
            ...
            //$result.push(predefault);
            $result.prop("disabled", !!this.readOnly);
            //$result.push('<div id="src'+glob_id_item+'" ></div>');   
            console.log($result);
            glob_id_item++;
            return predefault;//,$result;
        }
    });
